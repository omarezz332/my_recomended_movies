...
class MovieDetailContent extends StatelessWidget {
        ...
        builder: (BuildContext context, MovieDetailsState state) {
          switch (state.movieDetailsState) {
            ...
            case RequistState.loaded:
              return _movieDetailWidget(context, state.movieDetails);
  ...
  Widget _movieDetailWidget(BuildContext context, MovieDetail? movieDetails) {
    log('MovieDetailContent: "${movieDetails?.title}"');
                ...
                child: ShaderMask(
                  ...
                  child: CachedNetworkImage(
                    width: MediaQuery
                        ...
                        .size
                        .width,
                    imageUrl: AppApis.imageBaseUrl(movieDetails?.backdropPath??''),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              (movieDetails?.voteAverage??1 / 2).toStringAsFixed(1),
                              style: const TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                letterSpacing: 1.2,
...
Widget _showRecommendations() => BlocBuilder<MovieDetailsBloc,MovieDetailsState>(
      ...
      delegate: SliverChildBuilderDelegate(
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: AppApis.imageBaseUrl(recommendation.backdropPath ?? ""),
